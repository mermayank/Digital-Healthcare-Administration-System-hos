  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <Card>
          <CardHeader><CardTitle>Services (X-ray, Blood Test, etc.)</CardTitle></CardHeader>
          <CardContent><div className="text-center py-12 text-gray-500">No services configured yet</div></CardContent>
        </Card>
      </main>
    </div>
  )
