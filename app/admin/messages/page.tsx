  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <Card>
          <CardHeader><CardTitle>Send Announcements</CardTitle></CardHeader>
          <CardContent><div className="text-center py-12 text-gray-500">Messaging system coming soon</div></CardContent>
        </Card>
      </main>
    </div>
  )
